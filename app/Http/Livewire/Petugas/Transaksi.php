...
class Transaksi extends Component
{
    ...
    public function pinjam(Peminjaman $peminjaman)
    {
        foreach ($peminjaman->detail_peminjaman as $detail_peminjaman) {
            $detail_peminjaman->motor->update([
                'stok' => $detail_peminjaman->motor->stok -1
            ]);
        }
        ...
        session()->flash('sukses', 'Motor berhasil dipinjam.');
    }
    ...
    public function kembali(Peminjaman $peminjaman)
    {
        ...
        session()->flash('sukses', 'Motor berhasil dikembalikan.');
    }
