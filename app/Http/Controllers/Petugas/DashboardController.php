...
class DashboardController extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        ...
        // terbaru
        $motor = Motor::limit(5)->latest()->get();
        ...
        return view('petugas/dashboard/index',
            compact(
                'count_motor', 'count_user', 'count_sedang_dipinjam', 'count_selesai_dipinjam',
                'motor', 'user', 'sedang_dipinjam', 'selesai_dipinjam'
            )
        );
    }
}
