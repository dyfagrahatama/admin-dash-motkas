...
use App\Http\Controllers\Peminjam\MotorController as PeminjamMotorController;
use App\Http\Controllers\Peminjam\KeranjangController;
use App\Http\Controllers\Petugas\MotorController;
...
Route::get('/', PeminjamMotorController::class);
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:admin|petugas'])->group(function () {
        ...
        Route::get('/motor', MotorController::class);
