 @if ($edit)
        <div class="modal fade show" id="modal-default" style="display: block; padding-right: 17px;">
            ...
            <div class="modal-content">
                ...
                <h4 class="modal-title">Edit Motor</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="produktor">Produktor</label>
                                <input wire:model="produktor" type="text" class="form-control" id="produktor">
                                @error('produktor') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                ...
                <span type="button" wire:click="update({{$motor_id}})" class="btn btn-success">Update</span>
                </div>
            </div>
            </div>
        </div>
