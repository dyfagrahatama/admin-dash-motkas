 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/chart" class="nav-link <?php echo $__env->yieldContent('active-chart'); ?>">
    ...
    <!-- /.sidebar -->
  </aside><?php /**PATH D:\PRAKTIKUM SBD\TA\laravel8_perpustakaan\resources\views/admin-lte/sidebar.blade.php ENDPATH**/ ?>