...
unset($__errorArgs, $__bag); ?>
                ...
                <span type="button" wire:click="update(<?php echo e($rak_id); ?>)" class="btn btn-success">Update</span>
                </div>
            </div>
            </div>
        </div>
    <?php endif; ?><?php /**PATH D:\PRAKTIKUM SBD\TA\laravel8_perpustakaan\resources\views/petugas/rak/edit.blade.php ENDPATH**/ ?>